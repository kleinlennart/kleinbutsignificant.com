...
execute: 
  enabled: false # rerender disabled until bug fixed
  # freeze: true
---
...
version](https://img.shields.io/github/commits-since/adityatelange/hugo-PaperMod/71ce72?style=flat&logo=github&label=Commits%20since%20last%20theme%20submodule%20pull)](https://github.com/adityatelange/hugo-PaperMod/compare/71ce72...master)
...
flowchart LR
  git(Get HEAD ref from\n .git/modules with inline R) -->|Badge| rmd(README.Rmd) -->|Render| md(README.md) 
```
...
```{{r}}
`r commit_badge(user = "adityatelange", repo = "hugo-PaperMod", sha = get_theme_sha(theme_dir = "PaperMod"))`
```
